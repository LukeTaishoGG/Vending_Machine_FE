;(() => {
  ...
  ;((a.id = 499),
    ...
    (a.modules = {
      ...
      1305: (a, b, c) => {
        Promise.resolve().then(c.bind(c, 9202))
      },
      1442: (a, b, c) => {
        'use strict'
      ...
      1551: (a, b, c) => {
        ...
        let d = (0, c(7954).registerClientReference)(
          function () {
            throw Error(
              'Attempted to call the default export of "/Users/luke/LDH/Works/VendingMachine/Vending_Machine_FE/src/views/UserPage.tsx" from the server, but it\'s on the client. It\'s not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.',
            )
          },
          '/Users/luke/LDH/Works/VendingMachine/Vending_Machine_FE/src/views/UserPage.tsx',
          'default',
        )
      },
      3033: (a) => {
      ...
      4681: (a, b, c) => {
        Promise.resolve().then(c.bind(c, 1551))
      },
      5800: (a, b, c) => {
        'use strict'
        ;(c.r(b),
                    ...
                    children: [
                      'user',
                      {
                        children: [
                          ...
                          {
                            page: [
                              () => Promise.resolve().then(c.bind(c, 1442)),
                              '/Users/luke/LDH/Works/VendingMachine/Vending_Machine_FE/src/app/(app)/user/page.tsx',
                            ],
                          },
                        ],
                      },
...
see more here https://nextjs.org/docs/messages/app-static-to-dynamic-error`),
      ...
      9202: (a, b, c) => {
        ...
        var d = c(1124),
          ...
          k = c(3094),
          l = c(820)
        let m = (0, j.R)(function (a, b) {
          let c = (0, k.V)('Heading', a),
            { className: e, ...f } = (0, h.M)(a)
          return (0, d.jsx)(l.B.h2, {
            ref: b,
            className: (0, i.cx)('chakra-heading', a.className),
            ...f,
            __css: c,
          })
        })
        ...
        let o = () => {
          ...
          return (0, d.jsx)(f.a, {
            ...
            maxW: '600px',
            mx: 'auto',
            children: (0, d.jsxs)(g.T, {
              spacing: 6,
              align: 'stretch',
              children: [
                (0, d.jsx)(m, { size: 'lg', children: 'ユーザーページ' }),
                a
                  ? (0, d.jsxs)(g.T, {
                      spacing: 4,
                      align: 'stretch',
                      children: [
                        (0, d.jsxs)(f.a, {
                          ...
                          borderRadius: 'md',
                          children: [
                            (0, d.jsx)(n.E, { fontWeight: 'bold', children: 'ユーザーID:' }),
                            (0, d.jsx)(n.E, { children: a.user_id }),
                          ],
                        }),
                        (0, d.jsxs)(f.a, {
                          p: 4,
                          ...
                          borderRadius: 'md',
                          children: [
                            (0, d.jsx)(n.E, { fontWeight: 'bold', children: 'メールアドレス:' }),
                            (0, d.jsx)(n.E, { children: a.email }),
                          ],
                        }),
                      ],
                    })
                  : (0, d.jsx)(n.E, { color: 'red.500', children: 'ログインしてください' }),
              ],
            }),
          })
        }
  ...
  b.C(a)
  var c = b.X(0, [838, 901, 381], () => b((b.s = 5800)))
  module.exports = c
})()
