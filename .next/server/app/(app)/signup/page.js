;(() => {
  ...
  ;((a.id = 736),
    ...
    (a.modules = {
      ...
      4010: (a, b, c) => {
        Promise.resolve().then(c.bind(c, 9015))
      },
      5678: (a, b, c) => {
        'use strict'
        c.d(b, { default: () => d })
        let d = (0, c(7954).registerClientReference)(
          function () {
            throw Error(
              'Attempted to call the default export of "/Users/luke/LDH/Works/VendingMachine/Vending_Machine_FE/src/views/SignUpPage.tsx" from the server, but it\'s on the client. It\'s not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.',
            )
          },
          '/Users/luke/LDH/Works/VendingMachine/Vending_Machine_FE/src/views/SignUpPage.tsx',
          'default',
        )
      },
      5745: (a, b, c) => {
        ...
        let l = ({
                  ...
                  (0, d.jsx)('form', {
                    ...
                    children: (0, d.jsxs)(h.T, {
                      ...
                      children: [
                        ...
                        (0, d.jsx)(k.$, { type: 'submit', colorScheme: 'blue', children: '登録' }),
                      ],
                    }),
                  }),
                  m &&
                    (0, d.jsx)(i.E, {
                      color: m.includes('成功') ? 'green.500' : 'red.500',
                      textAlign: 'center',
                      children: m,
                    }),
                ],
          ...
          m = () => {
            let {
              ...
              let [a, b] = (0, e.useState)({ userId: '', email: '', password: '' }),
                [c, d] = (0, e.useState)(''),
                g = async (b) => {
                  ;(b.preventDefault(), d(''))
                  try {
                    ...
                    d(b.success ? b.message : b.error)
                  } catch (a) {
                    ;(console.error('サインアップエラー:', a), d('予期しないエラーが発生しました'))
                  }
                }
              return {
                userId: a.userId,
                setUserId: (a) => b((b) => ({ ...b, userId: a })),
                email: a.email,
                setEmail: (a) => b((b) => ({ ...b, email: a })),
                password: a.password,
                setPassword: (a) => b((b) => ({ ...b, password: a })),
                message: c,
                handleSubmit: g,
              }
            })()
                    ...
                    children: [
                      'signup',
                      {
                        children: [
                          ...
                          {
                            page: [
                              () => Promise.resolve().then(c.bind(c, 1101)),
                              '/Users/luke/LDH/Works/VendingMachine/Vending_Machine_FE/src/app/(app)/signup/page.tsx',
                            ],
                          },
                        ],
                      },
...
see more here https://nextjs.org/docs/messages/app-static-to-dynamic-error`),
      ...
      9506: (a, b, c) => {
        Promise.resolve().then(c.bind(c, 5678))
      },
      9902: (a) => {
        'use strict'
  ...
  b.C(a)
  var c = b.X(0, [838, 901, 381], () => b((b.s = 9468)))
  module.exports = c
})()
